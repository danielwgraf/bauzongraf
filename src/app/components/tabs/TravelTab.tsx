  ...
  return (
    <section className="min-h-screen pt-24 pb-16 px-4 bg-secondary">
      <main className="max-w-3xl mx-auto">
        <p className="font-oldforge text-2xl text-primary mb-2">Getting There</p>
        ...
        <div className="mb-14">
          <h3 className="font-oldforge text-2xl md:text-3xl text-primary mb-4">Suggested Airports</h3>
          <div className="space-y-6 font-cormorant text-lg text-stone-800">
            <div className="border-l-2 border-secondary pl-6">
              <h4 className="font-sans font-semibold text-primary mb-1">Bordeaux–Mérignac (BOD)</h4>
              <p>About 2 hours by car. Good international connections and a straightforward drive east into the Dordogne.</p>
            </div>
            <div className="border-l-2 border-secondary pl-6">
              <h4 className="font-sans font-semibold text-primary mb-1">Toulouse–Blagnac (TLS)</h4>
              <p>About 2 hours by car. Northbound to the Dordogne; another solid option if you find better flights.</p>
            </div>
            <div className="border-l-2 border-secondary pl-6">
              <h4 className="font-sans font-semibold text-primary mb-1">Paris (CDG / Orly)</h4>
              <p>About 5–6 hours by car or TGV to Bordeaux then car. Best if you&apos;re already in Paris or combining with a longer trip.</p>
            </div>
          </div>
        </div>
        <div>
          <h3 className="font-oldforge text-2xl md:text-3xl text-primary mb-4">By Car</h3>
