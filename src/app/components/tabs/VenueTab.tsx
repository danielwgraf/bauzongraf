  ...
  return (
    <section className="relative min-h-screen pt-24 pb-16 px-4 bg-secondary overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <p className="font-oldforge text-xl text-stone-800 mb-4">
        ...
        <p className="font-oldforge text-sm tracking-widest text-stone-600 uppercase mb-6">Protected cultural heritage · 3 hectares of park · Infinity pool & chapel</p>
        <a
